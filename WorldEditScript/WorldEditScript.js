...
sg.ww = ctx.getScreenWidth();
sg.wh = ctx.getScreenHeight();
//var ww = ctx.getWindowManager().getDefaultDisplay().getWidth();
//var wh = ctx.getWindowManager().getDefaultDisplay().getHeight();
//sg.ww = (ww > wh) ? ww : wh;
//sg.wh = (ww < wh) ? ww : wh;
...
var messageContainer = {
		...
		msg_not_init: "Please wait while ready...",
		
		add: "Add",
		delete: "Delete",
		select_type: "Select type...",
		msg_touch_block_for_add: "Touch block to register with edit tool.\nIf no corresponding block touch with another.",
		msg_select_next_changeable_block: "({%d}) block selected. Touch ({%c}) block",
		msg_finish_select_changeable_block: "Register complete {%r}",
		warn_unknown_error: "Unknown Error",
		block_rotation_and_flip: "Rotation & Flip with block",
		edit_custom_changeable_block_data: "Edit Rotation & Flip list",
		warn_delete: "Are you sure delete?"
	},
	...
	ko_KR: {
		...
		msg_not_init: "로딩이 완료될때까지 기다려주세요...",

		add: "추가",
		delete: "삭제",
		select_type: "타입을 선택하세요...",
		msg_touch_block_for_add: "등록할 블럭을 에딧도구로 클릭하세요.\n대응하는 블럭이 없으면 다른 아이템으로 터치하면 됩니다.",
		msg_select_next_changeable_block: "({%d})블럭이 선택되었습니다. ({%c})블럭을 선택하세요",
		msg_finish_select_changeable_block: "등록이 완료되었습니다 {%r}",
		warn_unknown_error: "알 수 없는 에러 발생",
		block_rotation_and_flip: "블럭도 같이 회전",
		edit_custom_changeable_block_data: "블럭 회전 목록 편집",
		warn_delete: "정말로 삭제하시겠습니까?"
	}
}
...
function WorldEdit() {
	...
	this.defaultSetting = {
		...
		HollowCircular: 0,
		Lang: 0,
		ImageX: Math.floor(sg.ww - (sg.px*0x20)),
	...
	this.defaultChangeableBlockData = {
		...
		FlipX: [[1073,1072],[849,848],[2145,2144],[2161,2160],[2177,2176],[2609,2608],[2625,2624],[1729,1728],[2049,2048],[1745,1744],[1825,1824],[2497,2496],[1045,1044],[1698,1704],[1026,1024],[1030,1028],[1032,1033],[3090,3088],[3094,3092],[3096,3097],[3106,3104],[3110,3108],[3112,3113],[3122,3120],[3126,3124],[3128,3129],[3138,3136],[3142,3140],[3144,3145],[3154,3152],[3158,3156],[3160,3161],[1138,1136],[1142,1140],[1144,1145],[1536,1537],[1544,1545],[1540,1541],[1548,1549],[2672,2673],[2680,2681],[2676,2677],[2684,2685],[1713,1715],[1717,1719],[2929,2931],[2933,2935],[2945,2947],[2949,2951],[2961,2963],[2965,2967],[2993,2995],[2997,2999],[2977,2979],[2981,2983],[417,419],[425,427],[869,868],[2341,2340],[981,980],[1379,1377],[1459,1457],[1020,1012],[1021,1011],[1022,1010],[1023,1009],[1019,1013],[1018,1014],[1017,1015],[1093,1092],[1059,1058],[1063,1062],[1064,1065],[435,434],[443,442],[451,450],[459,458],[2019,2018],[2027,2026],[1105,1106],[1113,1114],[1217,1218],[2293,2292],[1237,1236],[2099,2097],[2103,2101],[801,802],[1076,1077],[852,853],[2148,2149],[2164,2165],[2180,2181],[2612,2613],[2628,2629],[1732,1733],[2052,2053],[1748,1749],[1828,1829],[2500,2501]],
		FlipY: [[1072,1076],[1074,1078],[1073,1077],[1075,1079],[848,852],[850,854],[849,853],[851,855],[2144,2148],[2146,2150],[2145,2149],[2147,2151],[2160,2164],[2162,2166],[2161,2165],[2163,2167],[2176,2180],[2178,2182],[2177,2181],[2179,2183],[2608,2612],[2610,2614],[2609,2613],[2611,2615],[2624,2628],[2626,2630],[2625,2629],[2627,2631],[1728,1732],[1730,1734],[1729,1733],[1731,1735],[2048,2052],[2050,2054],[2049,2053],[2051,2055],[1744,1748],[1746,1750],[1745,1749],[1747,1751],[1824,1828],[1826,1830],[1825,1829],[1827,1831],[2496,2500],[2498,2502],[2497,2501],[2499,2503],[704,712],[707,715],[2528,2536],[2529,2537],[2530,2538],[2531,2539],[2532,2540],[2533,2541],[708,716],[705,713],[709,717],[710,718],[711,719],[1537,1541],[1539,1543],[1536,1540],[1538,1542],[1545,1549],[1547,1551],[1544,1548],[1546,1550],[2673,2677],[2675,2679],[2672,2676],[2674,2678],[2681,2685],[2683,2687],[2680,2684],[2682,2686],[1109,1111],[1117,1119],[1110,1104],[1118,1112],[2289,2288],[1233,1232]],
		FlipZ: [[1075,1074],[851,850],[2147,2146],[2163,2162],[2179,2178],[2611,2610],[2627,2626],[1731,1730],[2051,2050],[1747,1746],[1827,1826],[2499,2498],[1043,1042],[1700,1697],[1027,1025],[1031,1029],[1033,1032],[3091,3089],[3095,3093],[3097,3096],[3107,3105],[3111,3109],[3113,3112],[3123,3121],[3127,3125],[3129,3128],[3139,3137],[3143,3141],[3145,3144],[3155,3153],[3159,3157],[3161,3160],[1139,1137],[1143,1141],[1145,1144],[1538,1539],[1546,1547],[1542,1543],[1550,1551],[2674,2675],[2682,2683],[2678,2679],[2686,2687],[1714,1712],[1718,1716],[2930,2928],[2934,2932],[2946,2944],[2950,2948],[2962,2960],[2966,2964],[2994,2992],[2998,2996],[2978,2976],[2982,2980],[416,418],[424,426],[866,867],[2338,2339],[978,979],[1378,1376],[1458,1456],[1016,1008],[1017,1023],[1018,1022],[1019,1021],[1015,1009],[1014,1010],[1013,1011],[1091,1090],[1061,1060],[1062,1065],[1063,1064],[437,436],[445,444],[453,452],[461,460],[2021,2020],[2029,2028],[1108,1107],[1116,1115],[1220,1219],[2290,2291],[1234,1235],[2098,2096],[2102,2100],[804,803],[1079,1078],[855,854],[2151,2150],[2167,2166],[2183,2182],[2615,2614],[2631,2630],[1735,1734],[2055,2054],[1751,1750],[1831,1830],[2503,2502]]
	}
...
we_changeableBlockDataDialog.prototype = {
	...
	build: function() {
		...
		this.dl = sgUtils.gui.buttonDialog(this.name, msg("close"), function(view) {this.dismiss()}, msg("add"), function(view) {
			...
			we_toast(msg("msg_touch_block_for_add"), 0, 5000);
			this.dismiss();
		}, this.btns);
	},
	...
	comfirmDelete: function(name, index) {
		var that = this;
		var dl = new sgUtils.gui.dialog(msg("warning"), sgUtils.gui.mcFastText(msg("warn_delete") + "\n\n" + name, sg.px*0x10, true, sgColors.re800, Color.GRAY, null, null, [sg.px*0x4, sg.px*0x4, sg.px*0x4, sg.px*0x4], null), msg("cancel"), function(view) {
			this.dismiss();
...
we_imageView.prototype = {
	...
	build: function() {
		...
		this.wd = new PopupWindow(this.imageView, sg.mp, sg.wh, false);
